...
type Config struct {
	...
	// AccessTokenDuration is the duration applied to the access token cookie
	AccessTokenDuration time.Duration `json:"access-token-duration" yaml:"access-token-duration" usage:"duration for the access token cookie"`
