...
type Resource struct {
	// URI the url for the resource
	URI string `json:"uri" yaml:"uri"`
	// Hostname is a hostname type
...
// VirtualHost defines the structure for a virtual host
type VirtualHost struct {
	// Hostname is the hostname of the site
	Hostname string `json:"hostname" yaml:"hostname"`
	// Upstream is the defined upstream
	Upstream string `json:"upstream" yaml:"upstream"`
	// Roles is a collection of roles to access this virtual host
	Roles []string `json:"roles" yaml:"roles"`
	// Resources is a collection of resources for this virtual host
	...
	EnableTokenHeader bool `json:"enable-token-header" yaml:"enable-token-header"`
...
type Config struct {
	...
	// VirtualHosts is a collection of vitualhosts
	VirtualHosts []*VirtualHost `json:"virtual-hosts" yaml:"virtual-hosts"`
